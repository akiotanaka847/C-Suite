...
Open `/demo` in the C-Suite UI. Click "Load" on any company card.
...
fixtures/companies/<name>/
  profile.yaml        # CompanyProfile schema (see csuite/memory/company_profile.py)
