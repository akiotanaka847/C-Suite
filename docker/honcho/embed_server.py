"""OpenAI-compatible embeddings sidecar for C-Suite's Honcho deploy.
...
process resolves it via `embed.process.csuite-honcho-dev.internal:8001`.
...
app = FastAPI(title="csuite-honcho-embed", version="1.0.0")
