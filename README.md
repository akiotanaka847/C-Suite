...
> Derived from [Open Executive](https://github.com/SenteLabsAI/OpenExecutive) by the Open Executive Contributors, licensed under Apache 2.0. See [NOTICE](NOTICE) for attribution and the record of changes.
...
This repository is a derivative work of [Open Executive](https://github.com/SenteLabsAI/OpenExecutive)
(Copyright 2025 Open Executive Contributors, Apache 2.0). The original [LICENSE](LICENSE) is
retained unchanged and modifications are recorded in [NOTICE](NOTICE), as required by
