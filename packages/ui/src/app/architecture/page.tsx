...
// packages/core/csuite/architecture/sections.py.
const SECTIONS = [
  ...
  { id: 'nojargon_proactive', label: "Without the Jargon: When You're Not Watching", sub: "Morning brief, check-ins, nudges — C-Suite doesn't wait to be asked." },
  ...
  { id: 'mcp_server', label: 'MCP Server', sub: 'C-Suite exposed as an MCP server — company context as resources and the specialist council as tools, over Streamable-HTTP at /mcp for external agents.' },
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-8 py-10 space-y-20">
          <div className="space-y-4">
            <div>
              <h1 className="text-2xl font-bold text-fg">C-Suite — Architecture</h1>
              <p className="mt-2 text-sm text-fg-muted">
                A reference map of how C-Suite is built — the components, data flow, and invariants of the running system, from the Executive orchestrator and its specialist council to the knowledge, memory, scheduling, and integration layers.
              </p>
            </div>
            <DiagramLegend />
          </div>
