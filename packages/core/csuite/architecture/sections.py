...
SECTIONS: list[SectionSpec] = [
    ...
    SectionSpec(
        ...
        sub="Morning brief, check-ins, nudges — C-Suite doesn't wait to be asked.",
    ...
    SectionSpec(
        id="mcp_server",
        title="MCP Server",
        sub="C-Suite exposed as an MCP server: company-grounded context as resources and the specialist council as tools, over Streamable-HTTP at /mcp for external agents (Claude Desktop, Cursor, Claude Code).",
