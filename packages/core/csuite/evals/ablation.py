...
It reuses the standard harness (``csuite.evals.runner.run_scenarios``)
...
Usage::
    ...
    python -m csuite.evals.ablation                 # all chat scenarios
    python -m csuite.evals.ablation --scenario finance_001
"""
...
async def _collect_scores(kind: str, scenario_id: str | None) -> dict[str, float | None]:
    ...
    """
    from csuite.evals.runner import run_scenarios
