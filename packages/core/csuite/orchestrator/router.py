...
from csuite.agents.board_comms import BoardCommsAgent
from csuite.agents.finance import FinanceAgent
from csuite.agents.hr_talent import HRAgent
from csuite.agents.legal import LegalAgent
from csuite.agents.marketing import MarketingAgent
from csuite.agents.operations import OperationsAgent
from csuite.agents.product import ProductAgent
from csuite.agents.strategy import StrategyAgent
from csuite.agents.talent import TalentAgent
from csuite.agents.triage import TriageAgent
...
async def _retrieve_failures_for_call(call: dict[str, str]) -> str:
    ...
    from csuite.knowledge.retriever import retrieve_failures
...
async def _prefetch_department_for_call(
    ...
    from csuite.memory.honcho_client import prefetch_department
