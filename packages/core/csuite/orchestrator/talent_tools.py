...
from csuite.talent.models import CandidateStage, EngagementStatus, OfferStatus
...
async def handle_extend_offer(tool_input: dict[str, Any]) -> str:
    from csuite.talent.offers import OfferActionError, extend_offer
...
async def handle_record_offer_decision(tool_input: dict[str, Any]) -> str:
    from csuite.talent.offers import OfferActionError, record_offer_decision
