...
class Settings(BaseSettings):
    ...
    # KNOWLEDGE_BUILTIN_N_RESULTS=0 (see csuite/evals/ablation.py).
    ...
    openrouter_app_title: str = Field("C-Suite", alias="OPENROUTER_APP_TITLE")
    ...
    honcho_workspace_id: str = Field("csuite", alias="HONCHO_WORKSPACE_ID")
    ...
    def _validate_honcho(self) -> "Settings":
        ...
        # but that crashed the csuite-api-dev deploy on 2026-05-25
    ...
    # Reasoning effort for deep-reasoning specialists. Opus 5 only supports
    ...
    exec_display_name: str = Field("C-Suite", alias="EXEC_DISPLAY_NAME")
    ...
    edgar_user_agent: str = Field(
        "CSuite-Monitor/1.0", alias="EDGAR_USER_AGENT"
    )
