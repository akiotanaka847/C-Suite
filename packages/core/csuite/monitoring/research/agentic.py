...
from csuite.monitoring.research.prompts import research_addendum_for
from csuite.monitoring.research.scrape_tool import (
    SCRAPE_URL_TOOL,
    SCRAPE_URL_TOOL_NAME,
    handle_scrape_url,
)
from csuite.monitoring.research.tools import EMIT_RESEARCH_FINDINGS_TOOL
from csuite.orchestrator.web_search_tool import build_web_search_tool
...
async def run_specialist_agentic(
    ...
    from csuite.agents.research_council import (
        get_research_model,
