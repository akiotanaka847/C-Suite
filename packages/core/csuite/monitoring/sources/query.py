...
from csuite.monitoring.models import SOURCE_KIND_QUERY, Signal, WatchlistItem
from csuite.monitoring.sources._http import strip_url_query, validate_target_url
