...
def _fixture_name_taken(slug: str) -> bool:
    ...
    from csuite.cli.fixture_loader import FIXTURES_ROOT
...
async def list_fixtures() -> dict:
    from csuite.cli.fixture_loader import list_all_fixtures
...
async def fixtures_reset(request: Request) -> dict:
    ...
    store instance.
    """
    from csuite.cli.fixture_loader import reset_all_state
    from csuite.config import get_settings
...
async def delete_fixture(name: str) -> dict:
    ...
    from csuite.cli.fixture_loader import FIXTURES_ROOT, get_fixture_status
    from csuite.config import get_settings
    from csuite.fixtures import store as fixtures_store
