...
class DepartmentCheckInWorkflow(Workflow):
    ...
    async def run(
        ...
        from csuite.audit.logger import get_audit_logger
        from csuite.departments import registry as dept_registry
        from csuite.memory import episodic
        from csuite.memory.episodic import get_recent_decisions
        ...
        from csuite.departments import registry as _dept_registry
        from csuite.departments import store as _dept_store
        ...
        try:
            from csuite.memory.honcho_client import append_department_note
...
def _render_goals(state: object) -> str:  # type: ignore[type-arg]
    from csuite.departments.models import DepartmentState
...
def _gate_proposed_actions(
    ...
    from csuite.departments.authority import gate_action
...
def _assemble_artifact(
    *,
    ...
    parts = [
        ...
        "",
        "---",
        "_Generated by C-Suite department check-in. "
