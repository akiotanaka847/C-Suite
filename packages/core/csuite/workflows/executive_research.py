...
from csuite.monitoring.research.dedup import dedup_findings
from csuite.monitoring.research.models import (
    ResearchFinding,
    ResearchRunSummary,
)
from csuite.monitoring.research.specialist_research import (
...
class ExecutiveResearchWorkflow(Workflow):
    ...
    async def run(
        ...
        from csuite.memory.episodic import get_active_initiatives
        ...
        from csuite.monitoring.research.verification import (
            verify_findings,
        )
        ...
        try:
            ...
            from csuite.knowledge.loader import ingest_text
            from csuite.knowledge.store import ChromaDBStore
...
async def _executive_synthesis_loop(
    ...
    from csuite.orchestrator.executive import (
        _ALL_SKILL_HANDLERS,
        _ALL_SKILL_TOOLS,
    )
    ...
    from csuite.workflows._synthesis import (
        execute_tool_calls,
...
async def _watchlist_analysis_loop(
    ...
    from csuite.providers import get_provider
    from csuite.workflows._synthesis import execute_tool_calls
