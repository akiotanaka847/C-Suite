...
from csuite.staff_onboarding import store as onboarding_store
from csuite.staff_onboarding.specialists import resolve_specialist
...
def _assemble(ctx: _Ctx) -> str:
    ...
    parts += [
        "",
        "---",
        "*Drafted by C-Suite from your company context. Review with the "
