...
from csuite.departments.models import DepartmentState, Goal
...
def _render_people_section(people: list | None = None) -> str:
    ...
    try:
        if people is None:
            from csuite.people.registry import list_people as _list_people
            people = _list_people()
...
def render_org_block() -> str:
    ...
    """
    try:
        from csuite.departments.registry import list_states
        from csuite.people.registry import list_people
