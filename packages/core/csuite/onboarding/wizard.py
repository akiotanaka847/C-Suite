...
WIZARD_STEPS = [
    {
        "step": 0,
        "title": "Welcome",
        "question": "Welcome to C-Suite. I'm going to ask you a few questions to set up your company profile. This usually takes about 5 minutes. Let's start — what is the name of your company?",
        "field": "name",
        "required": True,
    },
    {
