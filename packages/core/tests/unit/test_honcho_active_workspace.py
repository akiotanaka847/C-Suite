...
def test_set_active_workspace_id_persists_and_overrides(_required_env: Path) -> None:
    honcho_client.set_active_workspace_id(
        "csuite-fixture-bombas-a1b2c3d4", fixture_name="bombas"
    )
    assert honcho_client.get_active_workspace_id() == "csuite-fixture-bombas-a1b2c3d4"
    ...
    assert payload["workspace_id"] == "csuite-fixture-bombas-a1b2c3d4"
...
def test_clear_active_workspace_id_falls_back_to_env(_required_env: Path) -> None:
    honcho_client.set_active_workspace_id("csuite-fixture-x-1234")
    assert honcho_client.get_active_workspace_id() == "csuite-fixture-x-1234"
...
def test_set_active_workspace_id_drops_cached_clients(_required_env: Path) -> None:
    ...
    try:
        ...
        honcho_client.set_active_workspace_id("csuite-fixture-x")
