...
from csuite.memory.episodic import initialize_db  # noqa: E402
from csuite.orchestrator.schedule_tools import (  # noqa: E402
    current_session,
    handle_suggest_workflow,
)
from csuite.orchestrator.session import Session  # noqa: E402
...
def test_intent_text_contains_deep_link_verbatim(
    ...
    from csuite.memory.episodic import _get_conn
