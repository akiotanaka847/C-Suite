...
from csuite.monitoring.research.models import ResearchFinding
from csuite.monitoring.research.specialist_research import (
    _extract_findings,
    research_one_specialist,
)
from csuite.workflows.executive_research import (
...
async def test_workflow_runs_end_to_end_with_stubbed_specialists(
    ...
    monkeypatch.setattr(
        "csuite.workflows.executive_research.research_one_specialist",
        fake_research_one,
    )
    ...
    monkeypatch.setattr(
        "csuite.workflows.executive_research._executive_synthesis_loop",
        fake_synth,
    )
    monkeypatch.setattr(
        "csuite.workflows.executive_research._watchlist_analysis_loop",
        fake_watchlist,
    )
...
def test_per_specialist_finding_cap_is_tight() -> None:
    ...
    from csuite.monitoring.research.prompts import (
...
def test_message_person_is_the_synthesis_dm_tool():
    ...
    from csuite.orchestrator.executive import _ALL_SKILL_TOOLS
