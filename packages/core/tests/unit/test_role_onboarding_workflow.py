...
from csuite.staff_onboarding import store
from csuite.staff_onboarding.models import OnboardingTemplate
from csuite.staff_onboarding.specialists import resolve_specialist
from csuite.workflows import role_onboarding
from csuite.workflows.role_onboarding import (
    RoleOnboardingInput,
