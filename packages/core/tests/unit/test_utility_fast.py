...
from csuite.agents.utility_fast import (  # noqa: E402
    UTILITY_FAST_AGENT_ID,
    UtilityFastAgent,
    get_fast_model,
)
from csuite.config import get_settings  # noqa: E402
...
def test_allowed_models_for_utility_fast_has_no_special_extras(
    ...
    from csuite.providers.registry import allowed_models_for
