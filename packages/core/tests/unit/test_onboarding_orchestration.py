...
from csuite.staff_onboarding import orchestration, service, store
from csuite.staff_onboarding.models import OnboardingPhase
...
async def test_activate_chat_tool_enqueues_and_404(db: Path) -> None:
    ...
    from csuite.orchestrator import onboarding_tools
