...
from csuite.alerts.models import (
    AlertChannel,
    AlertEvent,
    AlertSeverity,
    TriageDecision,
...
from csuite.alerts.preferences import (
    matches_mute,
    resolve_channels,
    save_preferences,
)
from csuite.alerts.store import add_mute, initialize_db, list_alerts
...
def test_save_and_reload_preferences(db: Path) -> None:
    ...
    from csuite.alerts.preferences import get_preferences
...
def test_evaluate_and_dispatch_persists_alert_and_publishes(monkeypatch, db: Path) -> None:
    ...
    from csuite.agents import triage as triage_module
    from csuite.alerts import pipeline, sse_bus
...
def test_evaluate_post_mute_suppresses(monkeypatch, db: Path) -> None:
    ...
    from csuite.agents import triage as triage_module
    from csuite.alerts import pipeline
...
def test_in_quiet_hours_wraparound_window() -> None:
    ...
    from csuite.alerts.preferences import _in_quiet_hours
