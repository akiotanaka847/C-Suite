...
from csuite.workflows.interview_coordination import (
...
def _run(candidate_id: int) -> list:
    ...
    with patch(
        "csuite.workflows.interview_coordination.route_to_specialist",
        new_callable=AsyncMock,
        side_effect=["LOOP_BODY", "AVAIL_BODY"],
    ), patch("csuite.workflows.interview_coordination.retrieve", return_value=""):
