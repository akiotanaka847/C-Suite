...
from csuite.clients import slots
from csuite.clients.engagement_activity import gather_engagement_activity
from csuite.clients.slots import activate_client_slot, create_client_slot
from csuite.workflows import WORKFLOW_REGISTRY
from csuite.workflows import engagement_value_report as evr
...
def _make_db(tmp_path: Path) -> Path:
    ...
    from csuite.workflows import persistence
...
def test_gatherer_totals_survive_the_listing_cap(tmp_path: Path) -> None:
    ...
    from csuite.workflows.engagement_value_report import _of_total
