"""Unit tests for csuite.orchestrator.people_tools.
...
from csuite.memory import episodic as episodic_module
...
def test_set_department_head_unknown_department_rejected() -> None:
    from csuite.agents.overrides import get_override
...
from csuite.orchestrator import people_tools as _people_tools_module  # noqa: E402
