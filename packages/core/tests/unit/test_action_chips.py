...
from csuite.orchestrator.action_chips import (
...
def _all_registered_tool_names() -> set[str]:
    ...
    """
    from csuite.orchestrator.artifact_tools import DRAFT_ARTIFACT_TOOL_HANDLERS
    from csuite.orchestrator.broadcast_tools import BROADCAST_TOOL_HANDLERS
    from csuite.orchestrator.department_tools import DEPARTMENT_TOOL_HANDLERS
    from csuite.orchestrator.mcp_gateway import MCP_TOOL_NAMES
    from csuite.orchestrator.people_tools import PEOPLE_TOOL_HANDLERS
    from csuite.orchestrator.schedule_tools import SCHEDULE_TOOL_HANDLERS
    from csuite.orchestrator.skills_tools import SKILL_TOOL_HANDLERS
    from csuite.orchestrator.talent_tools import TALENT_TOOL_HANDLERS
    from csuite.orchestrator.workflow_run_tools import WORKFLOW_RUN_TOOL_HANDLERS
