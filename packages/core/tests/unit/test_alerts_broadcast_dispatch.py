...
from csuite.alerts import dispatcher, store
from csuite.alerts.models import Alert, AlertChannel, TriageDecision
...
async def test_department_channel_calls_broadcast_tool(
    ...
    import csuite.orchestrator.broadcast_tools as bt
...
def test_triage_parser_propagates_broadcast_fields() -> None:
    ...
    """
    from csuite.agents.triage import _parse_decision
...
async def test_resolve_channels_keeps_broadcast_channels(
    ...
    from csuite.alerts.preferences import resolve_channels
