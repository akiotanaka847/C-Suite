...
from csuite.agents import overrides as agent_overrides
from csuite.alerts import store as alert_store
from csuite.departments import registry as dept_registry
from csuite.departments import store as dept_store
from csuite.departments.completeness import check_org_completeness
from csuite.departments.head_persona import ensure_head_persona_override
...
from csuite.workflows.resumer import sweep_stale_awaiting
...
class TestDedupNamespacing:
    ...
    def test_same_person_same_summary_is_deduplicated(self) -> None:
        from csuite.departments.authority import propose_via_alert
...
class TestStartupSweep:
    ...
    def test_run_resumer_awaits_sweep_at_startup(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "csuite.workflows.resumer.sweep_stale_awaiting", mock_sweep
        )
