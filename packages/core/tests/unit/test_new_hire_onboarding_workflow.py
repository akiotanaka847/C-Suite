...
from csuite.workflows.new_hire_onboarding import (
...
def _run(candidate_id: int, start_date: str = "") -> list:
    ...
    with patch(
        "csuite.workflows.new_hire_onboarding.route_to_specialist",
        AsyncMock(return_value="PLAN_BODY"),
    ), patch("csuite.workflows.new_hire_onboarding.retrieve", return_value=""):
...
def test_rehire_into_new_department_replaces_stale_slugs(
    ...
    from csuite.workflows import new_hire_onboarding as wf_module
