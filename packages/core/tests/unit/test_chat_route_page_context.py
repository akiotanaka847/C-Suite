...
from csuite.api.models import PageContext, PageFormDescriptor, PageFormField
from csuite.api.routes import chat as chat_route
from csuite.api.routes.chat import (
    _PAGE_FORM_JSON_MAX_CHARS,
    _build_page_context_block,
)
from csuite.memory import episodic, session_store
...
def patched_deps(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from csuite.knowledge import retriever as retriever_mod
    from csuite.memory import honcho_client as honcho_mod
    from csuite.onboarding import profile_builder
...
def _install_capturing_executive(
    ...
    from csuite.orchestrator import executive as exec_mod
...
def test_page_context_block_reaches_stream_chat(
    ...
    from csuite.guide import prebuilt as guide_prebuilt
