...
from csuite.scheduler import runner
from csuite.workflows import WORKFLOW_REGISTRY
from csuite.workflows.executive_reflection import (
...
def test_action_chips_registry_drift_still_passes() -> None:
    ...
    from csuite.orchestrator.action_chips import SIDE_EFFECTING_TOOLS
