...
from csuite.agents.base import BaseAgent  # noqa: E402
...
def _patch_settings_and_anthropic(monkeypatch: pytest.MonkeyPatch) -> AsyncMock:
    ...
    monkeypatch.setattr(
        "csuite.agents.base.get_provider",
...
def test_analyze_uses_default_when_no_override(tmp_db: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("csuite.agents.base.get_settings", lambda: SimpleNamespace(anthropic_api_key="x", specialist_effort="low"))
