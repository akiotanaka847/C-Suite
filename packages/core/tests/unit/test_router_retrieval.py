...
from csuite.orchestrator import router
...
def test_route_parallel_uses_supplied_map_when_provided(
    ...
    monkeypatch.setattr("csuite.knowledge.retriever.retrieve", boom)
