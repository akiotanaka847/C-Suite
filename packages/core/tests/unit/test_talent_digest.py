...
from csuite.briefing import talent_digest
from csuite.briefing.talent_digest import (
    STALL_THRESHOLD_DAYS,
    build_talent_brief_items,
    format_talent_for_prompt,
)
from csuite.talent import store as talent_store
from csuite.talent.models import CandidateStage, EngagementStatus
...
def _seed_extended_offer(engagement_id: int, candidate_id: int, *, expires_in_hours: float) -> int:
    ...
    from csuite.talent.models import OfferStatus
