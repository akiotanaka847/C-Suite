...
from csuite.api.routes import today as today_route
from csuite.briefing import narrative as briefing_narrative
...
from csuite.people import insights_cache
...
def _no_real_insight_generation(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    directly instead."""
    from csuite.people import insights as insights_mod
