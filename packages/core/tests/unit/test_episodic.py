...
def test_extract_and_store_includes_existing_initiatives_in_user_turn(
    ...
    from csuite.memory import episodic as ep
    ...
    monkeypatch.setattr("csuite.providers.get_provider", lambda _m: fake_provider)
    monkeypatch.setattr(
...
def test_extraction_prompt_includes_source_attribution_rule() -> None:
    ...
    """
    from csuite.memory.episodic import _EXTRACTION_SYSTEM, _EXTRACTION_TOOL
...
def test_min_turn_chars_for_extraction_is_exported_and_sane() -> None:
    ...
    """
    from csuite.memory.episodic import MIN_TURN_CHARS_FOR_EXTRACTION
...
def test_executive_call_sites_use_min_turn_chars_constant() -> None:
    ...
    from csuite.orchestrator import executive
...
def test_extraction_schema_requires_user_commitment_quote_on_every_item() -> None:
    ...
    """
    from csuite.memory.episodic import _EXTRACTION_TOOL
...
def test_is_valid_user_commitment_accepts_real_declarative_quote() -> None:
    from csuite.memory.episodic import _is_valid_user_commitment
