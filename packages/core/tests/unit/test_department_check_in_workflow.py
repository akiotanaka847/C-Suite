...
def _run_workflow(slug: str = "finance", period: str = "2026-05-21") -> list:
    ...
    with patch(
        "csuite.orchestrator.router.route_to_specialist",
        ...
        "csuite.audit.logger.get_audit_logger",
...
def test_workflow_run_recorded_in_persistence(tmp_path: Path) -> None:
    ...
    from csuite.workflows.persistence import complete_run, create_run, get_run
